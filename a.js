    ...
    rl.question('Enter guild id: ', async (guildId) => {
        ...
        rl.question('Enter the id of the voice channel to join: ', async (voiceChannelId) => {
            ...
            rl.question('Enter the path to the audio file: ', (audioPath) => {
                rl.question('Do you want to loop the audio? (y/n): ', (loopAnswer) => {
                    const shouldLoop = loopAnswer.toLowerCase() === 'y';
                    handling(guildId, voiceChannelId, audioPath, shouldLoop);
                    rl.close();
                });
            });
        });
...
async function handling(guildId, voiceChannelId, audioPath, shouldLoop) {
    ...
    try {
        ...
        player(audioPath, connection, shouldLoop);
...
async function player(audioPath, connection, shouldLoop) {
    const player = createAudioPlayer();
    const createResource = () => createAudioResource(fs.createReadStream(audioPath));
